...
//       const { imgUrl, ...eventDataWithoutImgUrl } = eventData;
...
//       const eventData = createTestEvent();
//       // eslint-disable-next-line @typescript-eslint/no-unused-vars
//       const { title, ...eventDataWithoutTitle } = eventData;
...
//       const eventData = createTestEvent();
//       // eslint-disable-next-line @typescript-eslint/no-unused-vars
//       const { eventDate, ...eventDataWithoutEventDate } = eventData;
...
//       const eventData = createTestEvent();
//       // eslint-disable-next-line @typescript-eslint/no-unused-vars
//       const { organizer, ...eventDataWithoutOrganizer } = eventData;
...
//       return request(getServer()).get('/api/events/invalid-id').expect(500);
//     });
//   });
...
//       const participantData = createTestParticipant();
//       // eslint-disable-next-line @typescript-eslint/no-unused-vars
//       const { fullName, ...participantDataWithoutFullName } = participantData;
...
//       const participantData = createTestParticipant();
//       // eslint-disable-next-line @typescript-eslint/no-unused-vars
//       const { email, ...participantDataWithoutEmail } = participantData;
...
//       const participantData = createTestParticipant();
//       // eslint-disable-next-line @typescript-eslint/no-unused-vars
//       const { dob, ...participantDataWithoutDob } = participantData;
...
// Response types based on your DTOs
interface EventResponse extends CreateEventDto {
  _id: string;
}
